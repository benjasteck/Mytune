...
public class Fake_PlaylistDAO {
    ...
    public Fake_PlaylistDAO() {
        ...
        playlist1.addSong(new Song(1,"testing1", "no idea", Category.Rap, 511,""));

        playlist2.addSong(new Song(1,"testing2", "no idea", Category.Rap, 511,""));
        playlist2.addSong(new Song(2,"testing3", "no idea", Category.Rap, 511, ""));

        playlist3.addSong(new Song(1,"testing4", "no idea",Category.Rap, 511, ""));
        playlist3.addSong(new Song(2,"testing5", "no idea", Category.Rap, 511, ""));
        playlist3.addSong(new Song(3,"testing6", "no idea", Category.Rap, 511, ""));
