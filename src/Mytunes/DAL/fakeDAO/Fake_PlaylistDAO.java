...
public class Fake_PlaylistDAO {
    ...
    public Fake_PlaylistDAO() {
        ...
        playlist1.addSong(new Song(1,"testing", "no idea", new Category("rap"), 511,""));

        playlist2.addSong(new Song(1,"testing", "no idea", new Category("rap"), 511,""));
        playlist2.addSong(new Song(2,"testing", "no idea", new Category("rap"), 511, ""));

        playlist3.addSong(new Song(1,"testing", "no idea", new Category("rap"), 511, ""));
        playlist3.addSong(new Song(2,"testing", "no idea", new Category("rap"), 511, ""));
        playlist3.addSong(new Song(3,"testing", "no idea", new Category("rap"), 511, ""));
